 ...
 */
const degenLockModule = buildModule('DegenLockModule', (m) => {
  ...
  const degenLock = m.contractAt('DegenLock', proxy);

  // Return the contract instance, along with the original proxy and proxyAdmin contracts
  // so that they can be used by other modules, or in tests and scripts.
  return { degenLock, proxy, proxyAdmin };
});

module.exports = degenLockModule;
